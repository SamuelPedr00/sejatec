        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 d-flex justify-content-center align-items-center">
                    <img src="img/PersonaSite.png" class="imgPrincipal img-fluid">
                </div>
                <div class="col-md-6 d-flex justify-content-center align-items-center">
                    <div class="row mt-3">
                        <div class="col-sm-12 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h3 class="card-text">Desenvolvemos sistemas personalizados sob medida para atender às necessidades específicas da sua empresa, utilizando as tecnologias mais avançadas disponíveis no mercado.</h3>
                                </div>
                            </div>
                        </div>
